...
void Java_com_ben_android_gifvideo_AnimatedDrawable_destroyDecoder(JNIEnv *env, jclass clazz, jlong ptr) {
    if (ptr == NULL) {
        return;
    }
...
void Java_com_ben_android_gifvideo_AnimatedDrawable_stopDecoder(JNIEnv *env, jclass clazz, jlong ptr) {
    if (ptr == NULL) {
        return;
    }
    VideoInfo *info = (VideoInfo *) (intptr_t) ptr;
...
void Java_com_ben_android_gifvideo_AnimatedDrawable_prepareToSeek(JNIEnv *env, jclass clazz, jlong ptr) {
    if (ptr == NULL) {
        return;
    }
    VideoInfo *info = (VideoInfo *) (intptr_t) ptr;
...
void Java_com_ben_android_gifvideo_AnimatedDrawable_seekToMs(JNIEnv *env, jclass clazz, jlong ptr, jlong ms) {
    if (ptr == NULL) {
        return;
    }
    VideoInfo *info = (VideoInfo *) (intptr_t) ptr;
...
jint Java_com_ben_android_gifvideo_AnimatedDrawable_getVideoFrame(JNIEnv *env, jclass clazz, jlong ptr, jobject bitmap, jintArray data, jint stride) {
